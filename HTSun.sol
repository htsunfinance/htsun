...
contract HTSun is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10**8 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "HT Sun";
    string private _symbol = "HTSUN";
    ...
    uint256 public _maxTxAmount = 5000 * 10**8 * 10**4;
    uint256 private numTokensSellToAddToLiquidity = 500 * 10**8 * 10**4;
